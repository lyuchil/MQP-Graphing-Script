...
commandline = f'C:/Users/claypool/Desktop/my_test/graph_script/MQP-Graphing-Script/PresentMon-1.9.2-x64.exe -output_file ./presentmon_testing/{file_name} -process_name Moonlight.exe -timed 10 -terminate_after_timed -no_top'
